...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'To reach your destination with the desired reserve, you need to charge {chargeAmount} kWh.'**
  String chargeMessage(Object chargeAmount);

  /// No description provided for @errorMessage.
  ///
  /// In en, this message translates to:
  /// **'It\'s not possible to reach the destination with the assumed parameters. The required energy ({chargeAmount} kWh) exceeds battery capacity.'**
